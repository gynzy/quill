  ...
  _createClass(Block, [{
    ...
    value: function formatAt(index, length, name, value) {
      ...
      if (_parchment2.default.query(name, _parchment2.default.Scope.BLOCK)) {
        ...
        _get(Block.prototype.__proto__ || Object.getPrototypeOf(Block.prototype), 'formatAt', this).call(this, index, Math.min(length, this.length() - index), name, value);
      }
      this.cache = {};
    }
  }, {
...
Quill.version =  false ? 'dev' : "1.3.10";
  ...
  bindings: {
    ...
    'tab': {
      ...
      handler: function handler(range, context) {
        ...
        this.quill.insertText(range.index, '\t', context.format, _quill2.default.sources.USER);
        this.quill.history.cutoff();
...
function handleEnter(range, context) {
  ...
  this.quill.insertText(range.index, '\n', context.format, _quill2.default.sources.USER);
